...
var boyToys = [{
    ...
    age = 39,
    height = "about 6 feet",
    hobbies = "picking up beautiful hoes, tinder, talking big game, getting spa treatments"
    ...
    age = 27,
    height = "6'2",
    hobbies = "skateboarding, snowboarding, EDM 4 Lyfe, cocaine, handing out Red Bull on college campuses"
}, {
    routeName = "hiImGreg",
    name = "Greg",
    age = 34,
